        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className={`
                absolute top-full left-0 mt-2 w-full min-w-[240px] bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50
              `}
            >
              ...
              {THEMES.map((t, index) => (
                <motion.button
                  ...
                  className={`
                relative group w-full flex items-center gap-3 px-5 py-2.5 hover:bg-[#262637] transition-all duration-200
